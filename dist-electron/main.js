  ...
  function graphics$1(callback) {
    ...
    function nvidiaSmi(options) {
      ...
      if (nvidiaSmiExe) {
        ...
        try {
          const sanitized = util2.sanitizeShellString(cmd);
                ...
                if (!error) {
                  ...
                  processSections.forEach((element) => {
                    if (element.trim() !== "") {
                      ...
                      let utime = parseInt(util2.getValue(lines, "UserModeTime", ":", true), 10);
                      let stime = parseInt(util2.getValue(lines, "KernelModeTime", ":", true), 10);
                      let mem = parseInt(util2.getValue(lines, "WorkingSetSize", ":", true), 10);
                      allcpuu = allcpuu + utime;
                      allcpus = allcpus + stime;
                      procStats.push({
                        pid,
...
function requireLib() {
  ...
  (function(exports) {
    ...
    exports.mem = memory2.mem;
    exports.memLayout = memory2.memLayout;
    exports.battery = battery2;
    exports.graphics = graphics2.graphics;
    exports.fsSize = filesystem2.fsSize;
    exports.fsOpenFiles = filesystem2.fsOpenFiles;
    exports.blockDevices = filesystem2.blockDevices;
    exports.fsStats = filesystem2.fsStats;
    exports.disksIO = filesystem2.disksIO;
    exports.diskLayout = filesystem2.diskLayout;
    exports.networkInterfaceDefault = network2.networkInterfaceDefault;
    exports.networkGatewayDefault = network2.networkGatewayDefault;
    exports.networkInterfaces = network2.networkInterfaces;
    exports.networkStats = network2.networkStats;
    exports.networkConnections = network2.networkConnections;
    exports.wifiNetworks = wifi2.wifiNetworks;
    exports.wifiInterfaces = wifi2.wifiInterfaces;
    exports.wifiConnections = wifi2.wifiConnections;
    ...
    exports.inetChecksite = internet2.inetChecksite;
    exports.inetLatency = internet2.inetLatency;
    exports.dockerInfo = docker2.dockerInfo;
    exports.dockerImages = docker2.dockerImages;
    exports.dockerContainers = docker2.dockerContainers;
    exports.dockerContainerStats = docker2.dockerContainerStats;
    exports.dockerContainerProcesses = docker2.dockerContainerProcesses;
    exports.dockerVolumes = docker2.dockerVolumes;
    exports.dockerAll = docker2.dockerAll;
    exports.vboxInfo = vbox.vboxInfo;
    exports.printer = printer2.printer;
    exports.usb = usb2.usb;
    exports.audio = audio2.audio;
    exports.bluetoothDevices = bluetooth2.bluetoothDevices;
...
var ntpClient$1 = {};
var hasRequiredNtpClient;
function requireNtpClient() {
  if (hasRequiredNtpClient) return ntpClient$1;
  hasRequiredNtpClient = 1;
  (function(exports) {
    (function(exports2) {
      var dgram = require$$0$3;
...
var ntpClientExports = requireNtpClient();
const ntpClient = /* @__PURE__ */ getDefaultExportFromCjs(ntpClientExports);
...
app.whenReady().then(() => {
  ...
  ipcMain.handle("get-system-info", async () => {
    try {
      ...
      return { cpu: cpu2, mem, graphics: graphics2, os, disk };
    } catch (error) {
