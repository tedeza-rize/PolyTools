    ...
    <div className="settings-page" style={{ backgroundColor: colors.background, color: colors.text }}>
      ...
      <div className="settings-content">
        <div className="settings-card">
          <h2 className="settings-card-title" style={{ color: colors.primary }}>{t('settings_theme')}</h2>
        ...
        <div className="settings-card">
          <h2 className="settings-card-title" style={{ color: colors.primary }}>{t('settings_language')}</h2>
          <div className="settings-card-content">
            <div className="setting-group">
              <label className="setting-item">
                <input
        ...
        <div className="settings-card">
          <h2 className="settings-card-title" style={{ color: colors.primary }}>{t('settings_info_section_title')}</h2>
          <div className="settings-card-content">
